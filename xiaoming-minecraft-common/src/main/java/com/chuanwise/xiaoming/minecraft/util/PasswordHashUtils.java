...
public class PasswordHashUtils {
    ...
    public static String createHash(String password)
        ...
        return createHash(password.toCharArray(), newSalt());
    }

    /**
     * Return a new password hash by certained salt
     *
     * @param password
     * @param salt
     * @return
    ...
    /**
     * Returns a new salt of password.
     *
     * @return a salt
     */
    public static byte[] newSalt() {
        byte[] result = new byte[SALT_BYTE_SIZE];
